...
export default {
  ...
  startGameTimeout: 45000,
  // ---------------------------------------------------------
  startRoundTime: 60000, // время на сбор участников для игры (30сек)
  ordersTime: 60000, // время заказов (30сек)
  minMemb: 0, // минимальное кол-во участников в игру
  roundTimeout: 25000, // время задержки между раундами
