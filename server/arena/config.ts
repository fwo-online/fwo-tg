...
export default {
  ...
  searchTimeout: 900000, // 15 минут - максимальное время поиска игры
  // ---------------------------------------------------------
  startRoundTime: 20000, // время на сбор участников для игры
  ordersTime: 20000, // время заказов (20сек)
  minMemb: 0, // минимальное кол-во участников в игру
  roundTimeout: 1500, // время задержки между раундами
