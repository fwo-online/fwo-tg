...
greeter.enter(({ reply }) => reply(
  'бла бла бла, сраный путник, бла бла бла. Выбери персонажа или создай нового',
...
create.on('text', ({ reply, message }) => {
  if (message.text.match(/Лучник|Воин|Маг|Лекарь/gi)) {
    ...
    reply(
      `Ты выбрал класс ${message.text}. ${message.text} – ${charDescr[message.text]}. Выбрать или вернуться назад?`,
